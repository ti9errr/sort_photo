...
SOURCE_DIRECTORY = "C:/mylocal/test/inbox"
DESTINATION_DIRECTORY = "C:/mylocal/test/Sorted_Pictures"

print "Source = %s" % (SOURCE_DIRECTORY)
print "Dest = %s" % (DESTINATION_DIRECTORY)
